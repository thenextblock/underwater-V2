...
import type { CSAI, CSAIInterface } from "../CSAI";
...
export class CSAI__factory {
  static readonly abi = _abi;
  static createInterface(): CSAIInterface {
    return new utils.Interface(_abi) as CSAIInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CSAI {
    return new Contract(address, _abi, signerOrProvider) as CSAI;
  }
}
