...
import type { CWBTC, CWBTCInterface } from "../CWBTC";
...
export class CWBTC__factory {
  static readonly abi = _abi;
  static createInterface(): CWBTCInterface {
    return new utils.Interface(_abi) as CWBTCInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CWBTC {
    return new Contract(address, _abi, signerOrProvider) as CWBTC;
  }
}
