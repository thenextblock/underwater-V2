...
import type { CBAT, CBATInterface } from "../CBAT";
...
export class CBAT__factory {
  static readonly abi = _abi;
  static createInterface(): CBATInterface {
    return new utils.Interface(_abi) as CBATInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CBAT {
    return new Contract(address, _abi, signerOrProvider) as CBAT;
  }
}
