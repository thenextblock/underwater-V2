...
import type { CZRX, CZRXInterface } from "../CZRX";
...
export class CZRX__factory {
  static readonly abi = _abi;
  static createInterface(): CZRXInterface {
    return new utils.Interface(_abi) as CZRXInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CZRX {
    return new Contract(address, _abi, signerOrProvider) as CZRX;
  }
}
