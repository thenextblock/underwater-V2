...
import type { CUSDC, CUSDCInterface } from "../CUSDC";
...
export class CUSDC__factory {
  static readonly abi = _abi;
  static createInterface(): CUSDCInterface {
    return new utils.Interface(_abi) as CUSDCInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CUSDC {
    return new Contract(address, _abi, signerOrProvider) as CUSDC;
  }
}
