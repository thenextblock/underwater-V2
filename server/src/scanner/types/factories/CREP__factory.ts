...
import type { CREP, CREPInterface } from "../CREP";
...
export class CREP__factory {
  static readonly abi = _abi;
  static createInterface(): CREPInterface {
    return new utils.Interface(_abi) as CREPInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CREP {
    return new Contract(address, _abi, signerOrProvider) as CREP;
  }
}
