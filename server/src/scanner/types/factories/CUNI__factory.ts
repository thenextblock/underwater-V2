...
import type { CUNI, CUNIInterface } from "../CUNI";
...
export class CUNI__factory {
  static readonly abi = _abi;
  static createInterface(): CUNIInterface {
    return new utils.Interface(_abi) as CUNIInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CUNI {
    return new Contract(address, _abi, signerOrProvider) as CUNI;
  }
}
