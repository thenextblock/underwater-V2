...
interface ComptrollerV4StorageInterface extends ethers.utils.Interface {
  functions: {
...
export class ComptrollerV4Storage extends BaseContract {
  ...
  interface: ComptrollerV4StorageInterface;
