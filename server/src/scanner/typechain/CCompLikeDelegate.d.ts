...
interface CCompLikeDelegateInterface extends ethers.utils.Interface {
  functions: {
...
export class CCompLikeDelegate extends BaseContract {
  ...
  interface: CCompLikeDelegateInterface;
