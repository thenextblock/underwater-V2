...
interface ComptrollerG3Interface extends ethers.utils.Interface {
  functions: {
    "_addCompMarkets(address[])": FunctionFragment;
    "_become(address,uint256,address[],address[])": FunctionFragment;
    "_becomeG3(uint256,address[],address[])": FunctionFragment;
    "_borrowGuardianPaused()": FunctionFragment;
    "_dropCompMarket(address)": FunctionFragment;
    ...
    "_setCompRate(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_addCompMarkets",
    values: [string[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "_dropCompMarket",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "_setMaxAssets",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "refreshCompSpeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "_becomeG3", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "_borrowGuardianPaused",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "MarketComped(address,bool)": EventFragment;
    ...
    "NewCompRate(uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "MarketComped"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewCompRate"): EventFragment;
...
export type MarketCompedEvent = TypedEvent<
  [string, boolean] & { cToken: string; isComped: boolean }
>;
...
export type NewCompRateEvent = TypedEvent<
  [BigNumber, BigNumber] & { oldCompRate: BigNumber; newCompRate: BigNumber }
>;
...
export type NewMaxAssetsEvent = TypedEvent<
  [BigNumber, BigNumber] & { oldMaxAssets: BigNumber; newMaxAssets: BigNumber }
>;
...
export class ComptrollerG3 extends BaseContract {
  ...
  interface: ComptrollerG3Interface;
  ...
  callStatic: {
    ...
    _dropCompMarket(cToken: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "MarketComped(address,bool)"(
      ...
      [string, boolean],
      { cToken: string; isComped: boolean }
    >;
    ...
    "NewCompRate(uint256,uint256)"(
      ...
      [BigNumber, BigNumber],
      { oldCompRate: BigNumber; newCompRate: BigNumber }
    >;
    ...
    "NewMaxAssets(uint256,uint256)"(
      ...
      [BigNumber, BigNumber],
      { oldMaxAssets: BigNumber; newMaxAssets: BigNumber }
    >;
