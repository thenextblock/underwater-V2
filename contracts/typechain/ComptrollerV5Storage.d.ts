...
interface ComptrollerV5StorageInterface extends ethers.utils.Interface {
  functions: {
...
export class ComptrollerV5Storage extends BaseContract {
  ...
  interface: ComptrollerV5StorageInterface;
